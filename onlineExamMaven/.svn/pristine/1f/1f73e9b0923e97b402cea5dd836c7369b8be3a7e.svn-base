            ...
            <ul class="nav nav-list">
                ...
                <li class="open">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="tiku_tiankong.jsp" class="open_li">
                                <i class="menu-icon fa fa-caret-right"></i>
                                填空题
                            </a>
                            <b class="arrow"></b>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <button class="add" onclick="$('#apple').show();" style="background-color: #2a91d8;color: #fff;height: 40px;outline: none;">添加填空题</button>
                        ...
                        <div style="width:100%;height: auto;padding-top: 5px;">
                            <div style="margin-left: 10px;font-size: 15px;">
                                ...
                                <form action="" method="get" style="text-indent: 2em;line-height: 25px;margin-top: 5px;">
                                    ...
                                    <!--<label><input name="Fruit" type="radio" value="">A：对 </label>&nbsp;-->
                                    <!--<label><input name="Fruit" type="radio" value="">B：错 </label>&nbsp;-->
                                </form>
                            </div>
                            <div style="width:100%;">
        ...
        <div class="popup_sure">
            ...
            <div class="popup_content">
                <form action="" method="">
                    ...
                    <br/>
                    题目：(填空题用“_”表示)<textarea cols="65" rows="3" name="title"></textarea>
                    <br/>
                    答案：(填空题之间用“、”隔开)<textarea cols="60" rows="2" ></textarea>
                    <br>
        ...
        <div class="popup_sure">
            ...
            <div class="popup_content">
                <form action="" method="">
                    ...
                    <br/>
                    答案：(填空题之间用“、”隔开)<textarea cols="60" rows="2" name="title"></textarea>
                    <br>
