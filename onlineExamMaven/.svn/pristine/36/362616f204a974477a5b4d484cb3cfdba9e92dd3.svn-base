            ...
            <ul class="nav nav-list">
                ...
                <li class="open">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="tiku_sheji.jsp" class="open_li">
                                <i class="menu-icon fa fa-caret-right"></i>
                                算法设计题
                            </a>
                            <b class="arrow"></b>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <button class="add" onclick="$('#apple').show();" style="background-color: #2a91d8;color: #fff;height: 40px;outline: none;">添加算法设计题</button>
                <div class="bank" style="width:100%;height:auto;margin-top: 10px;">
                    <div style="width:100%;height:auto;border: 1px #CCCCCC solid">
                        ...
                        <div style="width:100%;height: auto;padding-top: 5px;">
                            ...
                            <div style="width:100%;">
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;答案：</span><textarea cols="90" rows="10" name="title"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
