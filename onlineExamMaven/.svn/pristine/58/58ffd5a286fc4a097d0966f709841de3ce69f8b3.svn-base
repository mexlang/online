                                ...
                                <div style="width:100%;height: auto;padding-top: 5px;">
                                    <div style="margin-left: 10px;font-size: 15px;">
                                        <div style="width:100%;">
                                            ...
                                            <span style="margin-left: 85%;font-size: 12px">
                                              <a onclick="addQuestionIntoTestpaper(${user.questionId});">
                                                <button style="background-color:#20C891;border-radius: 5px;color:white">
                                                加入试题篮
                                                </button>
                                                </a>
                                            </span>
                                        ...
                                        <form action="" method="get" style="text-indent: 2em;line-height: 25px;margin-top: 5px;">
                                            ${ite.count}. ${user.questionName}<br/>
                                            <label><input name="Fruit" type="radio" value="">对 </label>&nbsp;
                                            <label><input name="Fruit" type="radio" value="">错 </label>&nbsp;
                                        </form>
                                    </div>
                                </div>
                            </div>
