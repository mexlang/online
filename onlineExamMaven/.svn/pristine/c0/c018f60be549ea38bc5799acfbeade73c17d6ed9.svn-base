            ...
            <ul class="nav nav-list">
                ...
                <li class="open">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="tiku_panduan.jsp" class="open_li">
                                <i class="menu-icon fa fa-caret-right"></i>
                                判断题
                            </a>
                            <b class="arrow"></b>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <button class="add" onclick="$('#apple').show();" style="background-color: #2a91d8;color: #fff;height: 40px;outline: none;">添加判断题</button>
