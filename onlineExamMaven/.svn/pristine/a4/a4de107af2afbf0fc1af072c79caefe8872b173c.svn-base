					...
					<div style="margin-left: 10px;font-size: 15px;">
						<div style="width:100%;">
							<span style="margin-left: 0;">【题文】</span> <span
								...
								<button class="revise" onclick="javascript:forUpdateDecide(${list.questionId});"
									style="background-color:#20C891;border-radius: 5px;color:white;outline: none;">修改</button>
								<button class="delete" onclick="javascript:deleteDecide(${list.questionId});"
						...
						<form action="" method="get"
							...
							<label><input name="Fruit" type="radio" value="">A：对
							</label>&nbsp; <label><input name="Fruit" type="radio" value="">B：错
							</label>&nbsp;
						</form>
					</div>
					<div style="width:100%;">
