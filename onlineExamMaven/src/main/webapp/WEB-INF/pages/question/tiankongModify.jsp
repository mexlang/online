...
<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel">填空题修改</h4>
</div>
	...
	<div class="smart-widget widget-purple">
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
				<form
					action="${pageContext.request.contextPath}/teacherChoice/updateBlankSystem"
					method="post">
					<input  type="hidden" name="blankUpdateId" id="blankUpdateId"  value="${onlineQuestions.questionId}"/>
					难度：<select name="questionDifficulty" id="blankUpdateDifficulty">
						<option value="简单"
						...
						name="questionChater" id="blankUpdateChater">
						<option value="one"
					...
					<textarea cols="65" rows="3" name="questionName" id="blankUpdateName">${onlineQuestions.questionName}</textarea>
					<input type="file" multiple name="questionPhoto" id="blankUpdatePhoto"
						value="${onlineQuestions.questionPhoto}"> <br />
					答案：(填空题之间用“@@”隔开)
					<textarea cols="60" rows="2" name="questionAnswer"
						id="blankUpdateAnswer">${onlineQuestions.questionAnswer}</textarea>
					<br>
				</form>
				<button id="submit" type="button" onclick="updateBlank();"
