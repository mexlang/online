        ...
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            ...
            <ul class="nav nav-list">
                ...
                <li class="">
                    ...
                    <ul class="submenu">
                        <li class="">
                            <a href="${pageContext.request.contextPath}/shiti/xuanze">
                        ...
                        <li class="">
                            <a href="${pageContext.request.contextPath}/shiti/panduan">
                                <i class="menu-icon fa fa-caret-right"></i>
                                判断题
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="${pageContext.request.contextPath}/shiti/tiankong">
                                <i class="menu-icon fa fa-caret-right"></i>
                                填空题
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="${pageContext.request.contextPath}/shiti/jianda">
                                <i class="menu-icon fa fa-caret-right"></i>
                                简答题
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="${pageContext.request.contextPath}/shiti/sheji">
                                <i class="menu-icon fa fa-caret-right"></i>
                                算法设计题
                            </a>
                            <b class="arrow"></b>
