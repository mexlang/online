					...
					<div style="margin-left: 10px;font-size: 15px;">
						<div style="width:100%;">
							<span style="margin-left: 0;">【题文】</span> <span
								...
								<button class="revise"
									onclick="javascript:forUpdateChoice(${list.questionId});"
									style="background-color:#20C891;border-radius: 5px;color:white;outline: none;">修改</button>
								<button class="delete"
									onclick="javascript:deleteChoice(${list.questionId});"
						...
						<form action="" method="get"
							...
							${list.questionName}<br /> <label><input name="Fruit"
								type="radio" value="">A：${list.optionA} </label>&nbsp; <label><input
								name="Fruit" type="radio" value="">B：${list.optionB} </label>&nbsp;
							<label><input name="Fruit" type="radio" value="">C：${list.optionC}
							</label>&nbsp; <label><input name="Fruit" type="radio" value="">D：${list.optionD}</label>&nbsp;
						</form>
					</div>
					<div style="width:100%;">
						<span>&nbsp;&nbsp;&nbsp;&nbsp;答案：</span>
